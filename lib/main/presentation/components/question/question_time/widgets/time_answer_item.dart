...
import '../view_model/time_answer_vm.dart';

class TimeAnswerItem extends StatelessWidget {
  final String format;
  TimeAnswerItem({Key? key, required this.format}) : super(key: key);

  final TimeAnswerViewModel viewModel = Get.find(tag: globals.tag);
