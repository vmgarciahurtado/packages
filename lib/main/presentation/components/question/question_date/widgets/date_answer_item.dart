...
import '../view_model/date_answer_vm.dart';

class DateAnswerItem extends StatelessWidget {
  final String format;
  DateAnswerItem({Key? key, required this.format}) : super(key: key);

  final DateAnswerViewModel viewModel = Get.find(tag: globals.tag);
